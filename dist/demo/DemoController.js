...
const demoRoute = new hono_1.Hono();
...
demoRoute.post("/create-dish", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const createMany = yield Connection_1.default.dishes.createMany({
            data: [
                {
...
demoRoute.post("/create-category", (c) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const createMany = yield Connection_1.default.taxonomy.createMany({
            data: [
                {
                    name: "Starters",
                    slug: "starters",
